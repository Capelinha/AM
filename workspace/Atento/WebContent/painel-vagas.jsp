...
<main class="contact-form" id="painel-vagas">
    ...
    <a href="detalhes-vaga.jsp">
        <article class="bloco-vaga">
            ...
            <h5 class="bloco-vaga-tipo">Auxiliar/Operacional</h5>
            <p class="bloco-vaga-texto">Atividades: Realizar a venda de produtos de adquirencia (maquinas de cartoes), para pessoas Fisicas...</p>

            <!--Local e data desejada-->
            <section class="bloco-vaga-det">
                <div class="bloco-vaga-local">
                    <i class="fas fa-map-marker-alt"></i>
                    <h5>Mirasol/São Paulo - Brasil</h5>
                </div>
                <div class="bloco-vaga-data">
                    <i class="far fa-calendar-check"></i>
                    <h5><time datetime="01/08/2018" >01/08/2018</date></h5>
                </div>
            </section>
