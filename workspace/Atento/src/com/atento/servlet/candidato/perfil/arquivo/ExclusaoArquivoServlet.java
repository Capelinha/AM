		...
		if (cookies != null) {
			...
			if ((idCandidato = cookiesH.get("idCandidato")) != null && (idSessao = cookiesH.get("idSessao")) != null) {
				try {
					...
					Mensagem mensagem = new Mensagem("Houve um problema ao excluir seu arquivo", "Infelizmente não conseguimos concluir sua exclusão.<b> Já estamos trabalhando para resolver esse problema.</b> Agradecemos a sua compreensão.", "VOLTAR", "javascript:history.back()");
